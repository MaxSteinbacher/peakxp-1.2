...
const SCHOOLS = [
  ...
  },
  {
    ...
    image: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/7d11e749c_Familie_Skifahren_Winter_24_25MirjaGeh_03.jpg",
    ...
    ageGroups: ["adults", "kids", "teens"],
    lessonTypes: ["group", "private", "half_day", "full_day"],
    priceHalfDay: 45, priceFullDay: 80, pricePrivate: 140,
    availability: "available",
    groupSize: "max 8",
    resort: "obertauern",
    phone: "+43 6456 7462",
    highlights: ["Ski & snowboard all levels", "Freeride & off-piste courses", "Airboarding school", "Kids courses from age 3"],
  },
  {
    id: "local-guides-am-tauern", name: "Local Guides am Tauern — Freeride Center", badge: "off_piste",
    image: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/d6ee6393f_Skifahren_Winter_24_25MirjaGeh_15.jpg",
    rating: 4.9, reviews: 78,
    location: "Obertauern, Salzburg, Austria",
    languages: ["German", "English"],
    certifications: ["ÖSV", "IFMGA"],
    instructors: 10,
    sports: ["ski"],
    levels: ["advanced", "expert"],
    ageGroups: ["adults"],
    lessonTypes: ["private", "full_day"],
    priceHalfDay: null, priceFullDay: 180, pricePrivate: 180,
    availability: "available",
    groupSize: "max 4",
    resort: "obertauern",
    phone: "+43 664 1634927",
    highlights: ["Freeride & off-piste with LVS training", "Avalanche safety courses", "Ski touring in Radstädter Tauern", "Local expert knowledge"],
  },
  {
    id: "snowboardschule-blue-tomato-obertauern", name: "Snowboardschule Blue Tomato", badge: "expert_pick",
    image: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/cd98df45c_Skifahren_Winter_24_25MirjaGeh_02.jpg",
    ...
    ageGroups: ["adults", "kids", "teens"],
    lessonTypes: ["group", "private", "half_day", "full_day"],
    priceHalfDay: 50, priceFullDay: 90, pricePrivate: 150,
    availability: "available",
    groupSize: "max 8",
    resort: "obertauern",
    phone: "+43 6456 20036",
    highlights: ["Dedicated snowboard school", "Beginners to advanced", "Freestyle & freeride", "All ages welcome"],
  },
  {
    id: "langlaufschule-gnadenalm-obertauern", name: "Langlaufschule Gnadenalm", badge: "cross_country",
    image: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/9c391399f_Familie_Skifahren_Winter_24_25MirjaGeh_15.jpg",
    rating: 4.8, reviews: 62,
    location: "Gnadenalm, near Obertauern",
    languages: ["German", "English"],
    certifications: ["ÖSV Nordic"],
    instructors: 8,
    sports: ["nordic"],
    levels: ["beginner", "intermediate"],
    ageGroups: ["adults"],
    lessonTypes: ["group", "private", "half_day"],
    priceHalfDay: 40, priceFullDay: 70, pricePrivate: 120,
    availability: "available",
    groupSize: "max 8",
    resort: "obertauern",
    phone: "+43 664 4139518",
    highlights: ["Classic & skating style", "20km Gnadenalmloipe access", "Laser biathlon sessions", "Night sledging at Gnadenalm"],
  },
  {
