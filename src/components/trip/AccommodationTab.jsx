...
const mockProperties = [
  ...
  { id: 2, name: "Alpenhof Boutique Hotel", type: "Hotel", location: "Verbier, Switzerland", price: 189, rating: 9.2, image: "https://picsum.photos/seed/hotel1/400/250", stars: 4, facilities: ["Spa", "Restaurant", "Free WiFi", "Ski storage"], boardBasis: "Bed and breakfast", cancellation: "Free cancellation" },
  { id: 3, name: "Chalet Blanc", type: "Chalet", location: "Courchevel, France", price: 420, rating: 9.5, image: "https://picsum.photos/seed/hotel2/400/250", stars: 5, facilities: ["Restaurant", "Free WiFi", "Ski-in ski-out", "Ski storage"], boardBasis: "Half board", cancellation: "Non-refundable" },
  { id: 4, name: "Mountain View Apartments", type: "Apartment", location: "Zermatt, Switzerland", price: 95, rating: 8.7, image: "https://picsum.photos/seed/hotel3/400/250", stars: 3, facilities: ["Free WiFi", "Parking"], boardBasis: "Room only", cancellation: "Free cancellation" },
  { id: 5, name: "Tyrolean B&B", type: "B&B", location: "St. Anton, Austria", price: 72, rating: 8.4, image: "https://picsum.photos/seed/hotel4/400/250", stars: 3, facilities: ["Free WiFi", "Bar"], boardBasis: "Bed and breakfast", cancellation: "Free cancellation" },
  { id: 6, name: "Summit Lodge", type: "Hotel", location: "Val Thorens, France", price: 155, rating: 8.9, image: "https://picsum.photos/seed/hotel5/400/250", stars: 4, facilities: ["Pool", "Restaurant", "Free WiFi", "Ski storage"], boardBasis: "Half board", cancellation: "Free cancellation" },
  { id: 7, name: "The Ski Haus", type: "Chalet", location: "Kitzbühel, Austria", price: 310, rating: 9.1, image: "https://picsum.photos/seed/hotel6/400/250", stars: 5, facilities: ["Ski-in ski-out", "Free WiFi", "Ski storage", "Bar"], boardBasis: "Full board", cancellation: "Non-refundable" },
];
