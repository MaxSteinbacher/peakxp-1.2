export const austrianResorts = [
  ...
  },
  {
    ...
    flag: "🇦🇹",
    lat: 47.52, lng: 12.19,
    minAltitude: 620, maxAltitude: 1957,
    verticalDrop: 1337,
    pisteKm: 284, runs: 279, lifts: 93,
    gondolas: 15, chairlifts: 48, dragLifts: 30,
    longestRun: 12,
    difficultyBlue: 45, difficultyRed: 42, difficultyBlack: 13,
    snowCannons: 420, snowCannonKm: 150,
    seasonStart: "2024-12-14", seasonEnd: "2025-04-06",
    openStatus: "Open", roadStatus: "clear",
    rating: 8.8, ratingLabel: "Excellent", priceFrom: 57,
    seasonDates: "14 Dec 2024 - 6 Apr 2025",
    seasonPasses: ["snowcard-tirol"],
    resortTypes: ["Alpine", "Family resort"],
    description: "The Ski Welt is the largest interconnected ski area in Austria by lift count covering nine villages. Ideal for intermediate skiers and families with 90 percent snowmaking coverage guaranteeing reliable conditions.",
    image: "https://picsum.photos/seed/ski-welt/800/500",
    images: ["https://picsum.photos/seed/ski-welt-1/1200/700", "https://picsum.photos/seed/ski-welt-2/1200/700", "https://picsum.photos/seed/ski-welt-3/1200/700"],
    ...
    liftsOpen: 85, liftsTotal: 93, pistesOpen: 250, pistesTotal: 279,
    ecoRating: 4, ecoRenewable: 70, ecoCertifications: ["ISO 14001"],
    ecoInitiatives: ["70% renewable electricity", "Recycled water snowmaking", "LED lighting across all lifts"],
    ecoOffsetProgram: false,
    airports: [
      { airport: "Innsbruck", iata: "INN", driveTime: "1h" },
      { airport: "Munich", iata: "MUC", driveTime: "1h 30m" },
      { airport: "Salzburg", iata: "SZG", driveTime: "1h 30m" }
    ],
    trainStation: "Worgl - 15km bus; Kufstein - 18km bus",
    shuttle: true, shuttleDesc: "Regular bus service from Worgl and Kufstein stations",
    parking: { capacity: 5000, pricePerDay: 10, includedInPass: false },
    facilities: {
      restaurants: [
        { name: "Harschbichl Restaurant", zone: "Mid-mountain", cuisine: "Austrian", price: "€€" },
        { name: "Panoramarestaurant Hohe Salve", zone: "Summit 1829m", cuisine: "Alpine", price: "€€€" }
      ],
      skiSchools: 9, groupLessonFrom: 44, privateLessonFrom: 110,
      languages: ["🇦🇹", "🇬🇧", "🇩🇪", "🇮🇹"],
    ...
    surroundings: {
      description: "The Wilder Kaiser mountains rise dramatically above nine traditional Tyrolean villages. Known for its dramatic rocky ridgeline and family-friendly atmosphere.",
      nearbyTowns: [
        { name: "Soll", distance: "0km", desc: "Traditional Tyrolean village with good nightlife" },
        { name: "Ellmau", distance: "5km", desc: "Charming village at the foot of the Wilder Kaiser" },
        { name: "Worgl", distance: "15km", desc: "Rail junction town in the Inn Valley" }
      ],
      activities: ["Snowshoeing", "Ice skating", "Spa & wellness", "Winter hiking", "Toboggan runs", "Curling"],
      touristBoard: "Ski Welt Tourismus",
    ...
    events: [
      { date: "22 Feb 2025", name: "Ski Welt Family Festival", type: "Family", desc: "Family fun day with prizes and entertainment" }
    ],
    promotions: [],
    liftPasses: [
      { type: "1-day", adult: 57, child: 29, senior: 51, badge: null },
      { type: "3-day", adult: 157, child: 79, senior: 141, badge: null },
      { type: "6-day", adult: 290, child: 145, senior: 261, badge: "Best value" },
