export const austrianResorts2 = [
  ...
  },
  {
    ...
    flag: "🇦🇹",
    lat: 47.25, lng: 13.56,
    minAltitude: 1630, maxAltitude: 2350,
    verticalDrop: 720,
    pisteKm: 100, runs: 37, lifts: 26,
    gondolas: 4, chairlifts: 14, dragLifts: 8,
    longestRun: 8,
    difficultyBlue: 54, difficultyRed: 38, difficultyBlack: 8,
    snowCannons: 90, snowCannonKm: 40,
    seasonStart: "2024-11-30", seasonEnd: "2025-05-01",
    openStatus: "Open", roadStatus: "chains",
    rating: 9.0, ratingLabel: "Exceptional", priceFrom: 59,
    seasonDates: "30 Nov 2024 - 1 May 2025",
    seasonPasses: ["superski"],
    resortTypes: ["Alpine", "Family resort"],
    description: "Obertauern sits at 1630m on the Tauern Pass and is famous for its exceptional snow record often receiving over 8 metres per season. The compact circular ski route means skiers always end up back at their hotel without traversing flat sections.",
    image: "https://picsum.photos/seed/obertauern/800/500",
    images: ["https://picsum.photos/seed/obertauern-1/1200/700", "https://picsum.photos/seed/obertauern-2/1200/700", "https://picsum.photos/seed/obertauern-3/1200/700"],
    weather: { temp: -7, snowDepth: 210, condition: "Snowy", forecast: [
    ...
    snowDepthBase: 120, snowDepthMid: 175, snowDepthTop: 220, snowType: "Powder",
    liftsOpen: 23, liftsTotal: 26, pistesOpen: 33, pistesTotal: 37,
    ...
    trainStation: "Radstadt - 25km bus connection",
    shuttle: false, shuttleDesc: "Bus connection from Radstadt station",
    parking: { capacity: 2000, pricePerDay: 12, includedInPass: false },
    facilities: {
      restaurants: [
        { name: "Seekarhutte", zone: "Summit area", cuisine: "Austrian", price: "€€" },
        { name: "Grillalm", zone: "Slope-side", cuisine: "Alpine", price: "€€" }
      ],
      skiSchools: 2, groupLessonFrom: 46, privateLessonFrom: 115,
      languages: ["🇦🇹", "🇬🇧", "🇩🇪"],
    ...
    surroundings: {
      description: "Obertauern sits on the ancient Tauern Pass at 1630m. The circular ski circuit is unique in the Alps - you always ski back to your door.",
      nearbyTowns: [
        { name: "Obertauern", distance: "0km", desc: "High-altitude pass resort with circular ski circuit" },
        { name: "Radstadt", distance: "25km", desc: "Historic walled town with train connections" },
        { name: "Salzburg", distance: "85km", desc: "Historic baroque city" }
      ],
      activities: ["Snowshoeing", "Spa & wellness", "Winter hiking", "Toboggan runs"],
      touristBoard: "Obertauern Tourismus",
      touristBoardUrl: "https://www.obertauern.com",
      emergency: "112",
      hospital: "LKH Schladming (35km)"
    },
    webcams: [
      { name: "Seekarspitze 2350m", seed: "obertauern-cam1" },
      { name: "Obertauern village", seed: "obertauern-cam2" }
    ],
    events: [
      { date: "Feb 2025", name: "Obertauern Snow Festival", type: "Festival", desc: "Annual snow and music festival" }
    ],
    promotions: [],
    liftPasses: [
      { type: "1-day", adult: 59, child: 30, senior: 47, badge: null },
      { type: "3-day", adult: 162, child: 81, senior: 130, badge: null },
      { type: "6-day", adult: 302, child: 151, senior: 242, badge: "Best value" },
      { type: "Season", adult: 1360, child: 680, senior: 1088, badge: null }
    ],
    instructors: [],
    reviews: {
      overall: 9.0,
      breakdown: { pistes: 9.0, lifts: 8.9, apresSki: 8.8, value: 8.7, beginners: 9.2 },
      items: []
    },
    seasonCalendar: [
      { month: "Nov", status: "partial" }, { month: "Dec", status: "open" },
