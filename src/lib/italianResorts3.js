export const italianResorts3 = [
  ...
  },
  {
    ...
    verticalDrop: 1083,
    pisteKm: 50, runs: 31, lifts: 15,
    gondolas: 4, chairlifts: 6, dragLifts: 5, practiceLifts: 5,
    longestRun: 8,
    difficultyBlue: 36, difficultyRed: 61, difficultyBlack: 3,
    snowCannons: 0, snowCannonCoveragePercent: 100,
    seasonStart: "2024-12-07", seasonEnd: "2025-04-06",
    openStatus: "Open", roadStatus: "open",
    rating: 8.6, ratingLabel: "Excellent", priceFrom: 44,
    seasonDates: "7 Dec 2024 - 6 Apr 2025",
    seasonPasses: ["skirama-dolomiti"],
    resortTypes: ["Alpine", "Family resort", "Night skiing"],
    description: "La Paganella sits in a strategic position in the heart of Trentino — just 20 minutes from the A22 motorway, 1 hour from Innsbruck, and an hour and a half from Verona. Spread across three aspects — Fai della Paganella, Andalo and Valle Bianca — it rises from 1,042m to 2,125m with panoramic views stretching from the Brenta Dolomites to Lake Garda. 50km of pistes served by 15 lifts (plus 5 tapis roulants), with 100% snowmaking coverage guaranteeing conditions from December through April. The Olimpionica II black piste is the official training ground of the Norwegian Alpine Ski National Team since 2011. Part of the Skirama Dolomiti circuit — one skipass for Madonna di Campiglio, Pinzolo, Folgarida-Marilleva, Ponte di Legno-Tonale, Pejo, Bondone and Alpe Cimbra.",
    image: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/37ab11ffe_FedericoModica269.jpg",
    images: [
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/a834828cc_FedericoModica2618.jpg", credits: "© Federico Modica / Paganella Ski" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/37ab11ffe_FedericoModica269.jpg", credits: "© Federico Modica / Paganella Ski" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/7e2c27458_FedericoModica2625.jpg", credits: "© Federico Modica / Paganella Ski" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/f88ddd2be_FedericoModica2650.jpg", credits: "© Federico Modica / Paganella Ski" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/89980b1c5_FedericoModica2655.jpg", credits: "© Federico Modica / Paganella Ski" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/93943d89a_FedericoModica2685.jpg", credits: "© Federico Modica / Paganella Ski" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/e9b5c0c7b_FedericoModica26113.jpg", credits: "© Federico Modica / Paganella Ski" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/a7ce09586_CamillaPizziniPh-4.jpg", credits: "© Camilla Pizzini / Paganella Ski" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/ed0d2c7e4_CamillaPizziniPh-20.jpg", credits: "© Camilla Pizzini / Paganella Ski" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/eef02e8f7_FedericoModica262.jpg", credits: "© Federico Modica / Paganella Ski" },
    ],
    ...
    liftsOpen: 13, liftsTotal: 15, pistesOpen: 27, pistesTotal: 31,
    ecoRating: 3, ecoRenewable: 62, ecoCertifications: ["ISO 14001"],
    ecoInitiatives: ["100% snowmaking coverage from purpose-built reservoirs", "Lake Molveno watershed protection", "Energy recovery systems on gondolas"],
    ecoOffsetProgram: false,
    specialTerrain: {
      nightSkiing: "Every Tuesday & Friday — Cacciatori 1 illuminated piste",
      tobogganRuns: 1,
      tobogganRunNames: ["Pista da slittino — Meriz"],
      skiTours: 3,
      skiTourNames: ["Tre-Tre (scialpinisti & ciaspolatori)", "Notturno da Fai della Paganella (Tue & Fri)", "Notturno da Andalo (Tue & Fri)"],
      funparks: 1,
      funparkLocations: ["Paganella Snowpark"],
    },
    familyHighlights: [
      "7 ski schools across the resort",
      "4 ski schools practice areas (2 on-mountain, 2 in-village)",
      "4 baby parks (2 on-mountain, 2 in-village — one at Andalo, one at Fai)",
      "Easy blue piste circuit in the Valle Bianca zone",
      "Norwegian Alpine National Team official training base since 2011",
      "Adaptive skiing — specialist instructors and equipment for disabled guests",
      "Summer: 80km of bike trails, Ferrata delle Aquile, family activities",
      "Sunrise mountain breakfasts and Dolomiti sunset aperitivo experiences",
      "Snow-cat nights — become a piste basher for the evening",
    ],
    airports: [
    ...
    trainStation: "Trento — 35km (bus connection). A22 motorway exit 20 minutes away.",
    shuttle: false, shuttleDesc: "Bus from Trento; direct road access from A22 (exit Trento Nord/San Michele all'Adige)",
    parking: { capacity: 1800, pricePerDay: 9, includedInPass: false },
    contact: {
      website: "www.paganella.net",
    },
    facilities: {
      restaurants: [
        { name: "Rifugio Paganella 2001", zone: "2001m — Gondola mid-station", cuisine: "Trentino", price: "€€" },
        { name: "Rifugio Monte Paganella", zone: "Summit 2125m", cuisine: "Alpine", price: "€€" },
        { name: "Rifugio Agostini", zone: "Valle Bianca", cuisine: "Trentino", price: "€€" },
        { name: "Baita Cacciatori", zone: "Fai della Paganella", cuisine: "Italian Alpine", price: "€€" },
        { name: "14 mountain rifugi", zone: "On-mountain", cuisine: "Trentino local produce", price: "€-€€€" },
      ],
      skiSchools: 7, groupLessonFrom: 38, privateLessonFrom: 96,
      languages: ["🇮🇹", "🇬🇧", "🇩🇪"],
      creche: true, crecheAgeMin: 3, crecheAgeMax: 6, crecheFrom: 46,
      kidsGarden: true, kidsGardenAge: "3-14", babysitting: true,
    ...
    surroundings: {
      description: "La Paganella rises dramatically above the Altopiano della Paganella, offering 360° panoramas from the Brenta Dolomites to Lake Garda and, on clear days, the Adamello massif. Andalo and Fai della Paganella are traditional Trentino villages surrounded by forests and Alpine meadows. The area is part of the Skirama Dolomiti multi-resort network — one skipass unlocks Madonna di Campiglio, Pinzolo, Folgarida-Marilleva, Ponte di Legno-Tonale, Pejo, Bondone and Alpe Cimbra.",
      nearbyTowns: [
        { name: "Andalo", distance: "0km", desc: "Family resort village with vibrant village life on the Paganella plateau" },
        { name: "Fai della Paganella", distance: "4km", desc: "Traditional Trentino village — one of three resort entry points" },
        { name: "Molveno", distance: "5km", desc: "Village on the beautiful Molveno lake beneath the Brenta Dolomites" },
        { name: "Trento", distance: "35km", desc: "Trentino-Alto Adige regional capital" }
      ],
      activities: ["Night skiing (Tue & Fri)", "Snowshoeing", "Night ski touring (Tre-Tre route)", "Toboggan run at Meriz", "Sunrise breakfast on the mountain", "Sunset aperitivo with Dolomiti views", "Snow-cat experience", "Winter hiking", "Lake Molveno walks", "Summer bike trails 80km", "Ferrata delle Aquile"],
      touristBoard: "Paganella Ski / Andalo Tourism",
      touristBoardUrl: "https://www.paganella.net",
      emergency: "112",
      hospital: "Ospedale di Cles (20km)"
    },
    webcams: [
      ...
      { name: "Fai della Paganella", seed: "andalo-cam3" }
    ],
    events: [
      { date: "Every Tue & Fri", name: "Night Skiing — Cacciatori 1", type: "Sport", desc: "Floodlit skiing on the Cacciatori 1 piste with night ski touring departures from Andalo and Fai" },
      { date: "Feb 2025", name: "Andalo Family Week", type: "Family", desc: "Family ski week with activities, competitions and mountain entertainment" },
      { date: "Winter season", name: "Norwegian National Team Training", type: "Sport", desc: "Norwegian Alpine National Team official training sessions on Olimpionica II black piste" },
    ],
    promotions: [],
    liftPasses: [
      { type: "1-day", adult: 44, child: 22, senior: 35, badge: null },
    ...
    passNote: "Skirama Dolomiti skipass also valid at Madonna di Campiglio, Pinzolo, Folgarida-Marilleva, Ponte di Legno-Tonale, Pejo, Bondone and Alpe Cimbra.",
    instructors: [],
    reviews: {
      overall: 8.6,
      breakdown: { pistes: 8.5, lifts: 8.6, apresSki: 8.4, value: 9.2, beginners: 9.4 },
      items: []
    },
    seasonCalendar: [
      { month: "Nov", status: "closed" }, { month: "Dec", status: "open" },
