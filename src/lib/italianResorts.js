export const italianResorts = [
  ...
  },
  {
    ...
    description: "A unique isolated summit mountain offering 360-degree views of the Dolomites and the Zillertal Alps with runs descending in all directions to five different valleys. Its 98 percent snowmaking coverage is among the highest of any resort in the Alps.",
    image: "https://picsum.photos/seed/kronplatz/800/500",
    images: ["https://picsum.photos/seed/kronplatz-1/1200/700", "https://picsum.photos/seed/kronplatz-2/1200/700", "https://picsum.photos/seed/kronplatz-3/1200/700"],
    ...
    ecoInitiatives: ["80% renewable electricity", "98% snowmaking coverage enabling natural snow preservation", "Green Globe certified"],
    ecoOffsetProgram: false,
    airports: [
      { airport: "Bolzano", iata: "BZO", driveTime: "45m" },
      { airport: "Innsbruck", iata: "INN", driveTime: "1h 30m" },
    ...
    trainStation: "Brunico/Bruneck - 10km bus",
    shuttle: false, shuttleDesc: "Bus from Brunico/Bruneck",
    parking: { capacity: 2500, pricePerDay: 11, includedInPass: false },
    facilities: {
      restaurants: [
        { name: "Edelweiss Summit Restaurant", zone: "2275m", cuisine: "South Tyrolean", price: "€€€" },
        { name: "Haberhutte", zone: "Mid-mountain", cuisine: "Alpine", price: "€€" },
        { name: "LUMEN Mountain Museum", zone: "2275m", cuisine: "Gourmet Alpine", price: "€€€" }
      ],
    ...
    surroundings: {
      description: "Kronplatz/Plan de Corones is a unique conical mountain rising in isolation above the Puster valley. The LUMEN mountain photography museum at the summit is one of the finest mountain museums in Europe.",
      nearbyTowns: [
        { name: "Brunico/Bruneck", distance: "10km", desc: "Main Puster valley city" },
        { name: "Reischach/Riscone", distance: "5km", desc: "Resort base village" },
        { name: "San Vigilio di Marebbe", distance: "15km", desc: "Quiet Ladin valley village" }
      ],
      activities: ["LUMEN museum visits", "Snowshoeing", "Cross-country skiing", "Puster valley walks", "South Tyrolean cuisine"],
      touristBoard: "Kronplatz Tourism",
      touristBoardUrl: "https://www.kronplatz.com",
      emergency: "112",
      hospital: "Ospedale di Brunico (10km)"
    },
    webcams: [
      { name: "Kronplatz summit 2275m", seed: "kronplatz-cam1" },
      { name: "Brunico valley base", seed: "kronplatz-cam2" }
    ],
    events: [
      { date: "Jan 2025", name: "Kronplatz Super G Ladies World Cup", type: "Competition", desc: "FIS Alpine Ski World Cup super-G for women" }
    ],
    promotions: [],
    liftPasses: [
