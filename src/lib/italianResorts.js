export const italianResorts = [
  ...
  },
  {
    ...
    seasonStart: "2025-11-29", seasonEnd: "2026-04-19",
    openStatus: "Open", roadStatus: "open",
    rating: 9.0, ratingLabel: "Exceptional", priceFrom: 56,
    seasonDates: "29 Nov 2025 – 19 Apr 2026",
    seasonPasses: ["dolomiti-superski"],
    resortTypes: ["Alpine", "Luxury", "Family resort"],
    description: "The premier ski resort of Trentino, nestled between the Adamello and Brenta Dolomite groups at 1,520 m. The SkiArea Madonna di Campiglio connects Campiglio with Folgarida, Marilleva and Pinzolo for 150 km of predominantly intermediate terrain beneath the UNESCO-listed Brenta Dolomites. The resort hosts the legendary 3-Tre World Cup slalom on the Canalone Miramonti each December — one of the most iconic night races on the FIS circuit. A royal favourite since Empress Sissi of Austria wintered here in the 19th century, the village combines elegant Belle Époque charm with world-class skiing. The signature Kids on Ski program offers free ski lessons for children aged 3–5, making it one of Italy's most family-friendly destinations.",
    image: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/a254d2b6f_DSCF1787copia.jpg",
    images: [
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/a254d2b6f_DSCF1787copia.jpg", credits: "© SkiArea Madonna di Campiglio — family on the ridge with Brenta Dolomites" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/66a787c35_DM_STLABS_ATPCampiglio_20200307_02110.jpg", credits: "© SkiArea Madonna di Campiglio — skier carving under the Brenta Dolomites" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/4f94faacc_sci.png", credits: "© SkiArea Madonna di Campiglio — two skiers on groomed run" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/23a2f7e5a_manuelrighi-31.jpg", credits: "© Manuel Righi — skier carving on corduroy" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/d73ee0c61_DM_STLABS_ATPCampiglio_20200307_01872.jpg", credits: "© SkiArea Madonna di Campiglio — skier carving with mountain backdrop" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/9c8e4eb39__DSC3057.jpg", credits: "© SkiArea Madonna di Campiglio — three skiers with Brenta Dolomites" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/859a7bfed_DSC1735_caterinacozzio.jpg", credits: "© Caterina Cozzio — skiers with Fortini gondola" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/a07be95d4_DSC1810_caterinacozzio.jpg", credits: "© Caterina Cozzio — two skiers on groomed slope at sunset" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/afe3ea23a_DSCF1448copia.jpg", credits: "© SkiArea Madonna di Campiglio — POV on groomed slope with Dolomites" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/64ad1b7c1_DSCF1940copia.jpg", credits: "© SkiArea Madonna di Campiglio — family playing in snow with dog" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/a57b425ec__DSC2674.jpg", credits: "© SkiArea Madonna di Campiglio — girl tossing snow with Brenta Dolomites" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/610fd133b__DSC2304.jpg", credits: "© SkiArea Madonna di Campiglio — family lunch in mountain rifugio" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/8b4c2831b_KidsOnSki1_caterinacozzio.jpg", credits: "© Caterina Cozzio — Kids on Ski program" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/04c1da6dd_KidsOnSki2_caterinacozzio.jpg", credits: "© Caterina Cozzio — Kids on Ski program" },
      { src: "https://media.base44.com/images/public/6a19694d2b38b5e31a976be8/877ec7e16_KidsOnSki3_caterinacozzio.jpg", credits: "© Caterina Cozzio — ski lesson with instructor" },
    ],
    weather: { temp: -6, snowDepth: 160, condition: "Sunny", forecast: [
      { day: "Today", high: -4, low: -10, condition: "clear" },
      { day: "Tomorrow", high: -5, low: -11, condition: "clear" },
    ...
    trainStation: "Trento — 60km bus. Direct ski trains from Milan and Verona to Trento, then bus to resort.",
    shuttle: true, shuttleDesc: "Bus from Trento to Madonna di Campiglio. Free ski bus within the resort connecting all lift stations.",
    parking: { capacity: 2000, pricePerDay: 12, includedInPass: false },
    facilities: {
      restaurants: [
        { name: "Rifugio Graffer", zone: "2,261m — Grostè", cuisine: "Trentino Alpine", price: "€€€" },
        { name: "Malga Ritorto", zone: "1,750m", cuisine: "Alpine", price: "€€" },
        { name: "Il Convivio", zone: "Village", cuisine: "Italian Gourmet", price: "€€€€" },
        { name: "Chalet Fiat", zone: "2,100m — Spinale", cuisine: "Alpine Party", price: "€€€" },
      ],
      skiSchools: 2, groupLessonFrom: 48, privateLessonFrom: 130,
      languages: ["🇮🇹", "🇬🇧", "🇩🇪", "🇫🇷"],
      creche: true, crecheAgeMin: 3, crecheAgeMax: 6, crecheFrom: 60,
      kidsGarden: true, kidsGardenAge: "3-12", babysitting: true,
      kidsProgram: "Kids on Ski — free ski lessons for children aged 3–5 (snowkids.it)",
      lockerCount: 900, lockerSizes: ["S", "M", "L", "XL"],
      skiStorage: true, skiStorageFrom: 10, bootDryers: true,
      rentalShops: 12, rentalBrands: ["Atomic", "Rossignol", "Salomon", "Head"],
      skiTuning: true, clothingShop: true, supermarket: true,
    ...
    surroundings: {
      description: "Madonna di Campiglio sits between the Adamello and Brenta Dolomite groups at 1,520 m in the Val Rendena. The Brenta Dolomites are a UNESCO World Heritage site, and the resort has been a royal favourite since Empress Sissi of Austria wintered here in the 19th century. The SkiArea connects Campiglio with Folgarida, Marilleva and Pinzolo, creating one of the largest ski domains in Trentino.",
      nearbyTowns: [
        { name: "Madonna di Campiglio", distance: "0km", desc: "Premier Trentino luxury resort — Belle Époque village between Adamello and Brenta Dolomites" },
        { name: "Pinzolo", distance: "15km", desc: "Valley town at the southern end of the SkiArea — linked by gondola" },
        { name: "Folgarida / Marilleva", distance: "20km", desc: "Linked ski villages in the Skirama network" },
        { name: "Trento", distance: "60km", desc: "Trentino regional capital with train connections" },
      ],
      activities: [
        "Kids on Ski — free ski lessons for children 3–5 years (snowkids.it)",
        "3-Tre World Cup spectating — December night slalom on Canalone Miramonti",
        "Snowshoeing — marked trails through Brenta Dolomites",
        "Spa & wellness — village spas and thermal baths",
        "Cross-country skiing — Val di Fassa circuits",
        "Brenta Dolomites hiking — UNESCO World Heritage",
        "Ice skating — village rink",
        "Ski touring — guided off-piste with mountain guides",
        "Winter via ferrata — equipped routes in the Brenta group",
      ],
      touristBoard: "SkiArea Madonna di Campiglio",
      touristBoardUrl: "https://www.ski.it",
      contact: { website: "www.ski.it", phone: "+39 0465 447 700" },
      emergency: "112",
      hospital: "Ospedale di Tione (20km)"
    },
    webcams: [
      { name: "Spinale 2,104m", seed: "madonna-cam1" },
      { name: "Grostè 2,437m", seed: "madonna-cam2" },
      { name: "Pradalago 2,100m", seed: "madonna-cam3" },
      { name: "Madonna di Campiglio village", seed: "madonna-cam4" },
    ],
    events: [
      { date: "Dec 2025", name: "3-Tre World Cup Slalom", type: "Competition", desc: "FIS Alpine Ski World Cup night slalom on the legendary Canalone Miramonti — one of the most iconic races on the circuit." },
      { date: "Jun 20–28, 2026", name: "Mountain Beat Festival", type: "Festival", desc: "Week of music and mountain culture in the SkiArea." },
      { date: "Jun 26–28, 2026", name: "3Tre Orienteering Madonna di Campiglio", type: "Competition", desc: "Orienteering event through the Brenta Dolomites." },
      { date: "Aug 28–30, 2026", name: "UCI Mountain Bike World Championships", type: "Competition", desc: "World championships of mountain biking on the SkiArea trails." },
      { date: "Sep 12–20, 2026", name: "I Suoni delle Dolomiti", type: "Festival", desc: "Iconic open-air music festival in the Dolomites — concerts at altitude." },
    ],
    promotions: [
      { headline: "Kids on Ski — free lessons", desc: "Free ski lessons for children aged 3–5 years through the Kids on Ski program. Visit snowkids.it for details.", badge: "Family" },
      { headline: "Skirama Dolomiti network", desc: "One pass covers Madonna di Campiglio, Folgarida, Marilleva, Pinzolo and more — 380 km across Trentino.", badge: "Best value" },
    ],
    liftPasses: [
      { type: "1-day", adult: 56, child: 28, senior: 45, badge: null },
      { type: "3-day", adult: 154, child: 77, senior: 123, badge: null },
